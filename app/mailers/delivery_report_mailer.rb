...
class DeliveryReportMailer < ApplicationMailer
  ...
  def bulk_mail(report_to, sent_message, total_recipients, total_emails_sendt, delivered_at, failed_recipients = nil)
    ...
    @total_emails_sendt = total_emails_sendt
  end
