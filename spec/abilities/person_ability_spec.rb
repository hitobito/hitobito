...
describe PersonAbility do
  ...
  context :layer_and_below_full do
    ...
    it "may not update root email if in same group" do
      ...
      is_expected.to be_able_to(:update, root)
    ...
    it "may show notes, tags and security in same layer" do
      ...
      is_expected.to be_able_to(:index_notes, other.person)
    ...
    it "may show person with deleted role in layer" do
      ...
      is_expected.to be_able_to(:show, other.person)
    end
    ...
    it "may not show person with deleted role in different layer" do
      ...
      is_expected.to_not be_able_to(:show, other.person)
    end
  ...
  context :layer_and_below_read do
    ...
    it "may modify himself" do
      is_expected.to be_able_to(:update, role.person)
    end
    ...
    it "may not view any externals in groups below" do
      other = Fabricate(Role::External.name.to_sym, group: groups(:bottom_layer_one))
      is_expected.not_to be_able_to(:show, other.person)
    end
  ...
  context :layer_full do
    ...
    it "may not show notes and tags in lower layer" do
      other = Fabricate(Group::BottomLayer::Member.name.to_sym, group: groups(:bottom_layer_one))
      is_expected.not_to be_able_to(:index_notes, other.person)
      is_expected.not_to be_able_to(:index_tags, other.person)
      is_expected.not_to be_able_to(:manage_tags, other.person)
    end
  ...
  context :contact_data do
    ...
    it "may view details of others in same group" do
      other = Fabricate(Group::TopGroup::Member.name.to_sym, group: groups(:top_group))
      is_expected.to be_able_to(:show_details, other.person)
    end
  ...
  describe "no permissions" do
    ...
    it "may view invoices of himself" do
      is_expected.to be_able_to(:index_invoices, role.person)
    end
    ...
    it "may not view details of others in same group" do
      other = Fabricate(Group::TopGroup::Leader.name.to_sym, group: groups(:top_group))
      is_expected.not_to be_able_to(:show_details, other.person)
    end
  ...
  context :show_details do
    let(:other) { Fabricate(Group::TopGroup::Member.name.to_sym, group: groups(:top_group)).person }
  ...
  context :send_password_instructions do
    ...
    context "layer and below full" do
      ...
      it "can send_password_instructions for external role" do
        external = Fabricate(Role::External.name.to_sym, group: groups(:top_group)).person
        is_expected.to be_able_to(:send_password_instructions, external)
      end

      it "cannot send_password_instructions for self" do
        is_expected.not_to be_able_to(:send_password_instructions, role.person)
      end
    end
