...
module PassDefinitionsHelper
  ...
  def format_pass_definition_background_color(pass_definition)
    ...
    safe_join([
      content_tag(:span, "", style: "display:inline-block;width:1em;height:1em;border-radius:50%;background:#{ERB::Util.html_escape(color)};border:1px solid black;vertical-align:middle;margin-right:0.4em"),
      color
    ])
  end
end
