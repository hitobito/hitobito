...
The architecture documentation in German can be found in [doc/architecture](doc/development/modules/common/architecture).
...
See [Gruppen- und Rollentypen](doc/development/modules/common/architecture/08_konzepte.md) for more details and
