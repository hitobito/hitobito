...
describe EventDecorator do
  ...
  describe "#dates" do
    ...
    it "joins multiple dates" do
      ...
      add_date(start_at: parse("2002-01-01"))
      subject.dates.should eq "01.01.2002<br/>01.01.2002"
    end
   
    context "date objects"  do
      it "start_at only" do
        add_date(start_at: parse("2002-01-01"))
        subject.dates.should eq "01.01.2002"
      end
      ...
      it "start and finish" do
        ...
        subject.dates.should eq "01.01.2002 - 13.01.2002"
      end
    ...
    context "time objects" do
      ...
      it "start and finish on same day, start time" do
        ...
        subject.dates.should eq "01.01.2002 13:30"
      end
      ...
      it "start and finish on same day, both times" do
        ...
        subject.dates.should eq "01.01.2002 13:30 - 15:30"
      end
    end
