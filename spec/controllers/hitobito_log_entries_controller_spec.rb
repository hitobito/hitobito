  ...
  describe "GET #index" do
    ...
    context "with admin permissions" do
      ...
      it "filters by to_date" do
        travel_to(Time.zone.now.midday) do
          to_date_param = 3.days.ago.to_date.to_formatted_s(:db)
      ...
      it "filters by from and to date/time" do
        travel_to(Time.zone.now.midday) do
          from_date_param = 3.days.ago.to_date.to_formatted_s(:db)
          to_date_param = 1.days.ago.to_date.to_formatted_s(:db)
