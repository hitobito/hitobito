...
describe Export::Pdf::Messages::Letter do
    ...
    context "single recipient" do
      ...
      it "renders text at positions without sender address" do
        expect(text_with_position).to match_array [
          [71, 678, "Bottom Member"],
          [71, 668, "Greatstreet 345"],
          [71, 657, "3456 Greattown"],
          [71, 531, "Information"],
          [71, 502, "Hallo"],
          [71, 481, "Wir laden "],
          [111, 481, "dich"],
    ...
    context "stamping" do
      ...
      it "renders addresses and content" do
        expect(text_with_position).to eq [
          ...
          [71, 460, "Bis bald"],
          [71, 678, "Top Leader"],
          [71, 668, "Funkystreet 42"],
          [71, 657, "4242 Supertown"],
          [71, 531, "Information"],
          [71, 502, "Hallo"],
          [71, 481, "Wir laden "],
          [111, 481, "dich"],
  ...
  context 'household addresses' do
    ...
    it 'creates only one letter per household' do
      expect(text_with_position).to eq [
        [71, 678, "Anton Abraham, Zora Zaugg"],
         [71, 668, housemate1.address],
         [71, 657, "#{housemate1.zip_code} #{housemate1.town}"],
         [71, 647, "DE"],
         [71, 531, "Information"],
         [71, 502, "Hallo"],
         [71, 481, "Wir laden "],
    ...
    it 'adds all household peoples names to address and sorts them alphabetically' do
      ...
      expect(text_with_position).to match_array [
        [71, 678, "Anton Abraham, Top Leader, Altra Mates, Bottom"],
        [71, 668, "Member, Zora Zaugg"],
        [71, 657, "Greatstreet 345"],
        [71, 647, "3456 Greattown"],
        [71, 531, "Information"],
        [71, 502, "Hallo"],
        [71, 481, "Wir laden "],
        [111, 481, "dich"],
    ...
    context 'household addresses' do
      ...
      it 'creates preview with half normal half household recipients' do
        expect(text_with_position).to match_array [
          ...
          [71, 502, "Hallo"],
          [71, 647, "DE"],
          [71, 678, "Bettina Büttel, Carlo Colorado"],
          [71, 668, housemate3.address],
          [71, 657, "#{housemate3.zip_code} #{housemate3.town}"],
          [71, 647, "DE"],
          [71, 502, "Hallo"],
          [71, 678, "Bottom Member"],
          [71, 668, bottom_member.address],
          [71, 657, "#{bottom_member.zip_code} #{bottom_member.town}"],
          [71, 502, "Hallo"],
          [71, 678, "Dominik Dachs"],
          [71, 668, single_person.address],
          [71, 657, "#{single_person.zip_code} #{single_person.town}"],
          [71, 647, "DE"],
          [71, 502, "Hallo"],
        ]
      end
      ...
      it 'includes all housemates, even when the underlying people scope is limited for previewing' do
        ...
        expect(text_with_position).to match_array [
          [71, 678, "Anton Abraham, Bettina Büttel, Carlo Colorado,"],
          [71, 668, "Zora Zaugg"],
          [71, 657, housemate1.address],
          [71, 647, "#{housemate1.zip_code} #{housemate1.town}"],
          [71, 636, "DE"],
          [71, 502, "Hallo"],
          [71, 678, "Bottom Member"],
          [71, 668, bottom_member.address],
          ...
          [71, 502, "Hallo"],
          [71, 678, "Top Leader"],
          [71, 668, top_leader.address],
          [71, 657, "#{top_leader.zip_code} #{top_leader.town}"],
          [71, 502, "Hallo"],
          [71, 678, "Dominik Dachs"],
          [71, 668, single_person.address],
          [71, 657, "#{single_person.zip_code} #{single_person.town}"],
