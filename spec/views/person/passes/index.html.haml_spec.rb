...
describe "person/passes/index.html.haml" do
  ...
  context "when person has no passes" do
    ...
    it "shows the empty state message" do
      expect(rendered).to include(I18n.t("person.passes.index.no_passes"))
    end
  ...
  context "when person has passes" do
    ...
    it "includes a link to the show action" do
      is_expected.to have_link(I18n.t("person.passes.index.show_pass"))
    end
    ...
    context "when google wallet is configured" do
      ...
      it "shows the Google Wallet button" do
        is_expected.to have_content(I18n.t("person.passes.index.add_to_google_wallet"))
      end
    end
    ...
    context "when apple wallet is configured" do
      ...
      it "shows the Apple Wallet button" do
        is_expected.to have_content(I18n.t("person.passes.index.add_to_apple_wallet"))
      end
    end
  end
end
