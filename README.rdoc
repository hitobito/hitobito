...
:layer_and_below_full::  May read and write everything in this layer and all below layers.
:layer_and_below_read::  May read everything in this layer and all below layers.
:layer_full::            May read and write everything in this layer.
:layer_read::            May read everything in this layer.
...
See {hitobito_generic}[https://github.com/hitobito/hitobito_generic] for a complete example group
structure.
...
Copyright 2012-2014 by Jungwacht Blauring Schweiz.
