...
RAILS_MAIL_RETRIEVER_CONFIG::   A comma-separated key: value list with all required
                                ...
                                valid options. If this variable is empty, mailing lists will not 
                                work.
RAILS_SPHINX_PORT::             Unique port of the sphinx server. Defaults to 9312.
