...
// Bundles the entrypoints - every .js directly in app/javascript, plus the
// ones the active wagons bring along (tmp/wagon_assets_manifest.json, written
