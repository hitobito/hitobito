...
describe Role do
  context "class" do
    ...
    its(:all_types) { is_expected.to have(14).items }

    its(:visible_types) { is_expected.to have(12).items }

    its(:visible_types) { is_expected.to_not include(Group::BottomGroup::Member) }
