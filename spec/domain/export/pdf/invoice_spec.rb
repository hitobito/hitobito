  ...
  context "with articles" do
    ...
    it "renders full invoice with vat" do
      ...
      invoice_text = [
        ...
        [456, 687, "1-10"],
        [347, 676, "Rechnungsdatum:"],
        [456, 676, "26.09.2022"],
        [347, 664, "Fällig bis:"],
        [456, 664, "26.10.2022"],
        [347, 653, "Rechnungssteller:"],
        [456, 653, "Top Leader"],
        [347, 641, "MwSt. Nummer:"],
        [456, 641, "CH 1234"],
        [57, 688, "Max Mustermann"],
        [57, 678, "Musterweg 2"],
        [57, 667, "8000 Alt Tylerland"],
        ...
        [418, 527, "10.00"],
        [514, 527, "10.0 %"],
        [390, 515, "Zwischenbetrag"],
        [502, 515, "20.00 CHF"],
        [390, 502, "MwSt."],
        [507, 502, "2.00 CHF"],
        [390, 487, "Gesamtbetrag"],
        [491, 487, "1'500.00 CHF"],
    ...
    it "renders full invoice without vat" do
      ...
      invoice_text = [
        ...
        [390, 515, "Zwischenbetrag"],
        [502, 515, "20.00 CHF"],
        [390, 499, "Gesamtbetrag"],
        [491, 499, "1'500.00 CHF"],
        [14, 276, "Empfangsschein"],
        [14, 251, "Konto / Zahlbar an"],
        [14, 239, "CH93 0076 2011 6238 5295 7"],
        [14, 228, "Acme Corp"],
    ...
    it "renders full invoice with payments" do
      ...
      invoice_text = [
        ...
        [418, 527, "10.00"],
        [468, 527, "20.00"],
        [401, 515, "Zwischenbetrag"],
        [502, 515, "20.00 CHF"],
        [401, 502, "Gesamtbetrag"],
        [502, 502, "20.00 CHF"],
        [401, 490, "Eingegangene Zahlung"],
        [502, 490, "10.00 CHF"],
        [401, 478, "Eingegangene Zahlung"],
        [506, 478, "5.00 CHF"],
        [401, 462, "Offener Betrag"],
        [502, 462, "20.00 CHF"],
        [14, 276, "Empfangsschein"],
        [14, 251, "Konto / Zahlbar an"],
        [14, 239, "CH93 0076 2011 6238 5295 7"],
