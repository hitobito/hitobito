...
describe Event::Date do
  ...
  it 'should get hours,mins and date seperately' do
    ...
    event_date.start_at_h.should == date.hour
    event_date.start_at_min.should == date.min
    # finish_at
    event_date.finish_at = date
    event_date.finish_at_date.should == date.to_date
    event_date.finish_at_h.should == date.hour
    event_date.finish_at_min.should == date.min
  end
