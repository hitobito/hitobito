...
All endpoints from the [JSON:API](modules/common/interfaces/json_api) can be used with service accounts. There are two possibilities to use the API:
...
All endpoints from the [JSON API](modules/common/interfaces/rest_api) can be used with service accounts. There are two possibilities to use the API:
