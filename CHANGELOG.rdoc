...
* Überprüfung bei Eingabe von Start- und Enddatum bei Kursen
* Info Feld auf Login-Maske für allgemeine Informationen (z.B. Wartungsfenster)
* Internationale Postleitzahlen
* Anzeige der Anzahl Personen die in einer Liste vorhanden sind
* Anzeige der Anzahl nicht sichtbaren Personen in Personen- und Teilnehmerlisten
* Bei Login senden Hinweis ob Person bereits über ein Login verfügt oder nicht
* Zulassen das beliebige Absender auf Mailinglisten schreiben können
* Verlinkung Geschwister
