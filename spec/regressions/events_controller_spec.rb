  ...
  describe "GET #index" do
    context ".html" do
      ...
      def event_with_date(opts = {})
        opts = {groups: [group], state: "application_open", start_at: Time.zone.today}.merge(opts)
    ...
    context ".csv" do
      ...
      it "renders events csv" do
        expect do
          ...
          expect(flash[:notice]).to match(/Export wird im Hintergrund gestartet und kann nach Fertigstellung auf der Jobübersicht/)
