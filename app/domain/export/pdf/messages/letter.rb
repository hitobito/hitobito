    ...
    def message_recipients
      ...
      if @letter.send_to_households?
        recipients = recipients.unscope(:select)
                          ...
                          :address
                          ).unscope(:order).order('max_last_name' => :asc).group(:address)
      end
      recipients
    end
  end
