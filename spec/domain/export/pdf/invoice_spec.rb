  ...
  context "with articles" do
    ...
    it "renders full invoice with vat" do
      ...
      invoice_text = [
        ...
        [14, 232, "Acme Corp"],
        [14, 223, "Hallesche Str. 37"],
        [14, 214, "3007 Hinterdupfing"],
        [14, 194, "Referenznummer"],
        [14, 185, "00 00834 96356 70000 00000 00019"],
        [14, 166, "Zahlbar durch"],
        [14, 156, "Max Mustermann"],
        [14, 147, "Musterweg 2"],
        [14, 137, "8000 Alt Tylerland"],
        [14, 89, "Währung"],
        [71, 89, "Betrag"],
        [14, 77, "CHF"],
        [71, 77, "1 500.00"],
        ...
        [346, 253, "Acme Corp"],
        [346, 241, "Hallesche Str. 37"],
        [346, 230, "3007 Hinterdupfing"],
        [346, 208, "Referenznummer"],
        [346, 196, "00 00834 96356 70000 00000 00019"],
        [346, 175, "Zahlbar durch"],
        [346, 163, "Max Mustermann"],
        [346, 151, "Musterweg 2"],
        [346, 140, "8000 Alt Tylerland"]
      ]
    ...
    it "renders full invoice without esr_number" do
      ...
      invoice_text = [
        ...
        [14, 185, "Max Mustermann"],
        [14, 176, "Musterweg 2"],
        [14, 166, "8000 Alt Tylerland"],
        [14, 89, "Währung"],
        [71, 89, "Betrag"],
        [14, 77, "CHF"],
        [71, 77, "1 500.00"],
        ...
        [346, 196, "Max Mustermann"],
        [346, 185, "Musterweg 2"],
        [346, 173, "8000 Alt Tylerland"]
      ]
