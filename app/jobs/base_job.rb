...
class BaseJob
  ...
  # Delayed::Worker.max_run_time (see `config/initializers/delayed_job_config.rb`).
  # Otherwise the lock on the job would expire and another worker would start
  # working on the in-progress job.
