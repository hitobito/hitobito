...
describe Wallets::GoogleWallet::Config do
  ...
  before do
    ...
    described_class.instance_variable_set(:@service_account_json, nil)
    described_class.instance_variable_set(:@private_key, nil)
    described_class.instance_variable_set(:@client_email, nil)
    described_class.instance_variable_set(:@parsed_credentials, nil)
